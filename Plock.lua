	...
	toggleButton.Image = "rbxassetid://130160749337944"
	...
	Tabs.Discord:AddButton({
		...
		Description = "Đây nha anh em ( Copy rồi dán vào trình duyệt )",
		Callback = function()
			setclipboard(tostring("https://discord.gg/s8R9b5NfsU"))
		end
	})
	local ReplicatedStorage = game:GetService("ReplicatedStorage")
	local Players = game:GetService("Players")
	if World3 then
		Tabs.Main:AddSection("Trẩu Roblox")
